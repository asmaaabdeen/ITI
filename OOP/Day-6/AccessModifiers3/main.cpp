...
//    c1.a; ///no///
//    c1.b; ///no///
///    c1.c; //no because it is protected
//    c1.d; ///no///
//    ci.e; ///no///
    c1.f; //yes
...
//    c2.a; ///no///
//    c2.b; ///no///
///    c2.c; // no because it is protected in the parent (fchild) class
//    c2.d; ///no///
//    c2.e; ///no///
///    c2.f; // no because it is private
//    c2.g; ///no///
//    c2.h; ///no///
    c2.i; // yes
*/
...
///    c1.a; ///no///
///    c1.b; ///no///
///   c1.c; //no cause it is inherited as private
///    c1.d; ///no///
///    ci.e; ///no///
      c1.f; //yes
