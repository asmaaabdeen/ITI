...
///*************************************************///
struct Employee * SearchList(int id){
...
void displayByID(int id){
    ...
    struct Employee *pDisplay = SearchList(id);
    if (pDisplay == NULL)
        printf("\n not found");
        else {
            system("cls");
...
void deleteByID(int id){
        struct Employee *pDelete = SearchList(id);
